...
#==========================
# Nothing Icons – Light (color-inverted) variant
#==========================
...
readonly DEFAULT_NAME="Nothing-Light"
...
#==========================
# Color inversion helpers
#==========================
invert_pngs() {
  local dir="$1"
  echo "  Inverting PNGs in ${dir} ..."
  python3 "${SRC_DIR}/invert_colors.py" "$dir"
}
...
build_shared_base() {
  ...
  # Invert scalable PNG icons only
  [ -d "${SHARED_BASE}/scalable" ] && invert_pngs "${SHARED_BASE}/scalable"
}
...
echo "Done. Select '${NAME}' in your icon theme settings."
